...
```json
{
  "canvasHost": {
    "enabled": true,
    "port": 18793,
    "root": "/Users/you/Cursor/Claude-2026/openclaw/canvas",
    "liveReload": true
  },
  "gateway": {
    "bind": "auto"
...
Place files in the canvas root directory (default `~/Cursor/Claude-2026/openclaw/canvas/`):

```bash
cat > ~/Cursor/Claude-2026/openclaw/canvas/my-game.html << 'HTML'
<!DOCTYPE html>
<html>
...
```
http://<host>:18793/__openclaw__/canvas/index.html  → ~/Cursor/Claude-2026/openclaw/canvas/index.html
http://<host>:18793/__openclaw__/canvas/games/snake.html → ~/Cursor/Claude-2026/openclaw/canvas/games/snake.html
```
